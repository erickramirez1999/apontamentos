"""Página Serasa — Carregamento (upload de arquivos CNAB)."""
import sys
...
st.set_page_config(page_title="Carregamento Serasa · LLE", page_icon="📤", layout="wide")
...
from src.telas.serasa_carregamento import renderizar
renderizar(usuario)
